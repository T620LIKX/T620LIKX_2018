...
s.t. Overlap2{t in 1..T??, c in 1..C, c_hat in 1..C: c <> c_hat}: x[c,t] + x[c_hat,t+1] <= 1 + z2[c,c_hat]; (t= 1,3,5,7,8,11,13,15,17,19)
s.t. Overlap2{t in 1..T??, c in 1..C, c_hat in 1..C: c <> c_hat}: x[c_hat,t] + x[c,t+1] <= 1 + z2[c,c_hat];

s.t. Overlap3{t in 1..T??, c in 1..C, c_hat in 1..C: c <> c_hat}: x[c,t] + x[c_hat,t+1] <= 1 + z3[c,c_hat]; (t = 2,4,6,8,12,14,16,18)
s.t. Overlap3{t in 1..T??, c in 1..C, c_hat in 1..C: c <> c_hat}: x[c_hat,t] + x[c,t+1] <= 1 + z3[c,c_hat];

s.t. Overlap4{t in 1..T??, c in 1..C, c_hat in 1..C: c <> c_hat}: x[c,t] + x[c_hat,t+2] <= 1 + z4[c,c_hat]; (t = 2,4,6,8,12,14,16,18)
s.t. Overlap4{t in 1..T??, c in 1..C, c_hat in 1..C: c <> c_hat}: x[c_hat,t] + x[c,t+2] <= 1 + z4[c,c_hat];

s.t. Overlap5{t in 1..T??, c in 1..C, c_hat in 1..C: c <> c_hat}: x[c,t] + x[c_hat,t+2] <= 1 + z5[c,c_hat];  (t= 1,3,5,7,11,13,15,17)
s.t. Overlap5{t in 1..T??, c in 1..C, c_hat in 1..C: c <> c_hat}: x[c_hat,t] + x[c,t+2] <= 1 + z5[c,c_hat];

s.t. Overlap6{t in 1..T??, c in 1..C, c_hat in 1..C: c <> c_hat}: x[c,t] + x[c_hat,t+3] <= 1 + z6[c,c_hat];  (t = 1,3,5,7,11,13,15,17)
s.t. Overlap6{t in 1..T??, c in 1..C, c_hat in 1..C: c <> c_hat}: x[c_hat,t] + x[c,t+3] <= 1 + z6[c,c_hat];
